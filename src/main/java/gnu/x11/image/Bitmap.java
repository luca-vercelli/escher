...
public class Bitmap extends Image {
	...
	public Bitmap(Display display, int width, int height) {
		...
		if (display.getImageByteOrder() != LSB_FIRST || display.getBitmapFormatBitOrder() != LEAST_SIGNIFICANT)
	...
	public void set(int x, int y) {
		...
		int index = y * lineByteCount + unit_index * unit_byte_count + unit_byte_index;
