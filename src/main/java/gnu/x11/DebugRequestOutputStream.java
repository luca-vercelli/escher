...
class DebugRequestOutputStream extends RequestOutputStream {
	...
	private static final String CLASS_NAME = DebugRequestOutputStream.class.getName();
	...
	public void beginRequest(int opcode, int second_field, int request_length) {
		...
		String message = "-----> BEGIN NEW REQUEST [opcode: " + opcode + " | seq_number: " + sequenceNumber
				+ " | second field: " + second_field + " | request length: " + request_length + " ] <-----";
	...
	public synchronized void flush() {
		...
		String message = "[opcode: " + super.opcode() + " | seq_number: " + sequenceNumber + "]";
	...
	public int getInt32(int index) {
		...
		int sequenceNumber = getSequenceNumber();
		String message = "[get_int32 - opcode: " + super.opcode() + " | seq_number: " + sequenceNumber + " | index: "
				+ index + " ]";
	...
	public void increaseLength(int i) {
		...
		int sequenceNumber = getSequenceNumber();
		String message = "[opcode: " + super.opcode() + " | seq_number: " + sequenceNumber + " | i: " + i + " ]";
	...
	void sendImpl() {
		...
		int sequenceNumber = getSequenceNumber();
		String message = "[opcode: " + super.opcode() + " | seq_number: " + sequenceNumber + " | index: " + getIndex()
				+ " ]";
	...
	public synchronized int setBufferSize(int size) {
		...
		int sequenceNumber = getSequenceNumber();
		String message = "[opcode: " + super.opcode() + " | seq_number: " + sequenceNumber + " | size: " + size + " ]";
	...
	public long skip(long n) {
		...
		int sequenceNumber = getSequenceNumber();
		String message = "[opcode: " + super.opcode() + " | seq_number: " + sequenceNumber + " | n: " + n + " ]";
	...
	public void writeBytes(byte[] b) {
		...
		int sequenceNumber = getSequenceNumber();
		String message = "[opcode: " + super.opcode() + " | seq_number: " + sequenceNumber + " | byte: " + b + " ]";
	...
	public void writeDouble(double d) {
		...
		int sequenceNumber = getSequenceNumber();
		String message = "[opcode: " + super.opcode() + " | seq_number: " + sequenceNumber + " | double: " + d + " ]";
	...
	public void writeFloat(float f) {
		...
		int sequenceNumber = getSequenceNumber();
		String message = "[opcode: " + super.opcode() + " | seq_number: " + sequenceNumber + " | float: " + f + " ]";
	...
	public void writeInt16(int v) {
		...
		int sequenceNumber = getSequenceNumber();
		String message = "[opcode: " + super.opcode() + " | seq_number: " + sequenceNumber + " | int16: " + v + " ]";
	...
	public void writeInt32(int v) {
		...
		int sequenceNumber = getSequenceNumber();
		String message = "[opcode: " + super.opcode() + " | seq_number: " + sequenceNumber + " | int32: " + v + " ]";
	...
	public void writeInt8(int v) {
		...
		int sequenceNumber = getSequenceNumber();
		String message = "[opcode: " + super.opcode() + " | seq_number: " + sequenceNumber + " | int8: " + v + " ]";
	...
	public void writeString16(String s) {
		...
		int sequenceNumber = getSequenceNumber();
		String message = "[opcode: " + super.opcode() + " | seq_number: " + sequenceNumber + " | String16: " + s + " ]";
	...
	public void writeString8(String s) {
		...
		int sequenceNumber = getSequenceNumber();
		String message = "[opcode: " + super.opcode() + " | seq_number: " + sequenceNumber + " | String8: " + s + " ]";
	...
	public void flushPending() {
		...
		int sequenceNumber = getSequenceNumber();
		String message = "!!!!! " + FLUSH_THREAD_NAME + " [ seq_number: " + sequenceNumber + " ] !!!!!";
	...
	boolean sendPendingRequest() {
		...
		String message = "-----> SEARCH_PENDING_REQUEST [ " + " seq_number: " + sequenceNumber + " ] <-----";
		...
		if (sent) {
			message = "-----> PENDING_REQUEST_SENT [ " + " seq_number: " + sequenceNumber + " ] <-----";
			logger.logp(Level.FINEST, CLASS_NAME, "sendPendingRequest", message);
		} else {
			message = "-----> NO_PENDING_REQUEST [ " + " seq_number: " + sequenceNumber + " ] <-----";
			logger.logp(Level.FINEST, CLASS_NAME, "sendPendingRequest", message);
		}
