...
public class Pixmap extends Drawable {
	...
	public static class Format {
		...
		/**
		 * If the scanline is not a multiple of this number, it needs to be padded (with
		 * zero bytes). The number of bytes to pad is the minum number of bytes required
		 * to make the scanline a multiple of the scanline pad returned by this method.
		 */
