...
public class DrawablePicture extends Picture {
	...
	public static class Attributes extends org.gnu.escher.x11.ValueList {
		...
		public void set_alpha_x_origin(int i) {
			set(2, i);
		}

		public void set_alpha_y_origin(int i) {
			set(3, i);
		}
		 ...
		 */
		public void set_repeat(boolean b) {
			set(0, b);
		}

		/**
		 * @param p possible: {@link DrawablePicture#NONE} (default)
		 */
		public void set_alpha_map(DrawablePicture p) {
			set(1, p.id);
		}
		...
		/**
		 * @param i valid: {@link #SHARP}, {@link #SMOOTH} (default)
		 */
		public void set_poly_edge(int i) {
			set(9, i);
		}
		...
		/**
		 * @param i valid: {@link #PRECISE} (default), {@link #IMPRECISE}
		 */
		public void set_poly_mode(int i) {
			set(10, i);
		}
	 ...
	 */
	public DrawablePicture(Render render, Drawable drawable, PictFormat format, Attributes attr) {
	 ...
	 */
	public void set_clip_rectangles(int x_origin, int y_origin, Rectangle[] rectangles) {
	...
	public void scale(int color_scale, int alpha_scale, DrawablePicture src, int src_x, int src_y, int dst_x, int dst_y,
	 ...
	 */
	public void fill_rectangle(int op, Color color, int x, int y, int width, int height) {
