 ...
 *
 * Glyph instances cannot be created directly. They must be create by adding
 * glyphs to a {@link GlyphSet}. It is important to store the created glyph
 * instances somewhere, otherwise they get garbage collected and the X server
 * frees the resources for that glyph.
 */
public final class Glyph {
	...
	/**
	 * Compares this object with another object. This object is only equal to the
	 * other object if the other object is also a Glyph instance and if both have
	 * the same ID and the same parent glyph set.
	 *
	...
	public boolean equals(Object o) {
		return o instanceof Glyph && ((Glyph) o).glyph_set == glyph_set && ((Glyph) o).id == id;
	}
