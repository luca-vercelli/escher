 ...
 */
public class GLX extends org.gnu.escher.x11.extension.Extension implements
        org.gnu.escher.x11.extension.ErrorFactory, org.gnu.escher.x11.extension.EventFactory {
    ...
    public X11ServiceException build(Display display, int code, int seq_no, int bad,
        ...
        return new X11ServiceException(display, code - firstError, seq_no, bad,
                         minor_opcode, major_opcode);
    }

    public org.gnu.escher.x11.event.Event build(Display display, ResponseInputStream i,
                                     int code) {
