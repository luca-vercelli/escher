...
public class VisualConfig {
	...
	/**
	 * Return -1 if {@code this}. VisualConfig is less then {@code template}, 0 is
	 * they are considered equal, and 1 if template is considered greater than
	 * {@code this}.
	 * 
	 * The algorithm used to determine how a VisualConfig is supposed to be less,
	 * greater or equal to another is pure magic and won't be explained here. But
	 * you can give a look at the GLX 1.3 spec and ARB_multisample, read the source
	 * code, or the MESA source code...
	 */
