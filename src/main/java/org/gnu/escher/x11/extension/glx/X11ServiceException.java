...
public class X11ServiceException extends org.gnu.escher.x11.X11ServiceException {
	...
	public static final String[] ERROR_STRINGS = { "BAD_GLX_CONTEXT: parameter not a GLX rendering context",
			"BAD_GLX_CONTEXT_STATE: state of GLX rendering context inconsistent",
			"BAD_GLX_DRAWABLE: parameter not a GLX drawable", "BAD_GLX_PIXMAP: parameter not a GLX pixmap",
			...
			"BAD_GLX_LARGE_REQUEST: series of GLX large requests" + "incomplete or invalid",
