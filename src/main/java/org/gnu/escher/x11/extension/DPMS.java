 ...
 * <a href= "http://escher.sourceforge.net/etc/specification/dpms-library.ps.gz"
 * >here</a> (<a href=
...
public class DPMS extends Extension {
	...
	/**
	 * Determine whether or not the currently running server's devices are capable
	 * of DPMS operations. There is a <a href= "../../../../etc/dpms-bug">bug</a> in
	 * all servers based on X Consortium sample implementation up to R6.5 (including
	 * XFree86 4.0.1 or earlier): the sequence number of the reply is incorrect,
	 * causing a "reply out of order" error.
	 *
