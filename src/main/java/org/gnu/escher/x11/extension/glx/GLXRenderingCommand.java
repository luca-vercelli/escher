...
public enum GLXRenderingCommand implements X11Command {
	...
	Begin(8, 4), CallList(8, 1), Clear(8, 127), ClearColor(20, 130), ClearDepth(12, 132), Color3fv(16, 8),
	DepthMask(8, 135), Enable(8, 139), End(4, 23), Frustum(52, 175), LoadIdentity(4, 176), Materialfv(12, 97),
	MatrixMode(8, 179), MultMatrixd(132, 181), Normal3fv(16, 30), Normal3iv(16, 31), Ortho(52, 182), PopMatrix(4, 183),
	PushMatrix(4, 184), ShadeModel(8, 104), ReadBuffer(8, 171), Rotatef(20, 186), Translatef(16, 190),
	Vertex3fv(16, 70), Viewport(20, 191);
