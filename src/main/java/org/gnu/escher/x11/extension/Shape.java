...
public class Shape extends Extension implements EventFactory {
	...
	/**
	 * @param destKind  valid: {@link Kind}
	 * 
	 * @param operation valid: {@link Operation}
	 * 
	 * @param ordering  valid: {@link Ordering}
	 * 
	 * @see <a href="XShapeCombineRectangles.html">XShapeCombineRectangles</a>
	 */
	public void combineRectangles(Window dest, Kind destKind, int xOffset, int yOffset, Rectangle[] rectangles,
	 ...
	 */
	public void combineMask(Window dest, Kind destKind, int xOffset, int yOffset, Pixmap src, Operation operation) {
	 ...
	 * @param destKind  valid: {@link Kind}
	 * 
	 * @param srcKind   valid: {@link Kind}
	 * 
	 * @param operation valid: {@link Operation}
	 * 
	 * @see <a href="XShapeCombineShape.html">XShapeCombineShape</a>
	 */
	public void combineShape(Window dest, Kind destKind, int xOffset, int yOffset, Window src, Kind srcKind,
			Operation operation) {
	...
	public static class RectanglesInfo implements InputStreamObject {
	...
	public static class NotifyEvent extends Event {
		...
		/**
		 * @return valid: {@link Kind}
		 */
		public Kind kind() {
			return Kind.getByCode(getDetail());
		}
