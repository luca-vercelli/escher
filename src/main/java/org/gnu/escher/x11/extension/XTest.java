...
public class XTest extends Extension {
	...
	/**
	 * @param cursor possible: {@link Cursor#NONE}, {@link Cursor#CURRENT}
	 *
	...
	public enum FakeEvent {
		KEY_PRESS(2), KEY_RELEASE(3), BUTTON_PRESS(4), BUTTON_RELEASE(5), MOTION_NOTIFY(6);
	 ...
	 */
	public void fakeInput(FakeEvent type, int detail, int delay, Window root, int x, int y) {
	...
	public void fake_button_event(int button, boolean press, int delay) {
		fakeInput(press ? FakeEvent.BUTTON_PRESS : FakeEvent.BUTTON_RELEASE, button, delay, Window.NONE, 0, 0);
	}
	...
	public void fakeKeyEvent(int keycode, boolean press, int delay) {
		fakeInput(press ? FakeEvent.KEY_PRESS : FakeEvent.KEY_RELEASE, keycode, delay, Window.NONE, 0, 0);
	}

	/**
	 * @see <a href="XTestFakeMotionEvent.html">XTestFakeMotionEvent</a>
	 */
	public void fakeMotionEvent(Window root, int x, int y, boolean relative, int delay) {
