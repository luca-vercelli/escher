...
public class DBE extends Extension implements ErrorFactory {
	...
	public DBE(org.gnu.escher.x11.Display display) throws ExtensionNotFoundException {
	...
	public X11ServiceException build(org.gnu.escher.x11.Display display, int code, int seqNumber, int bad,
