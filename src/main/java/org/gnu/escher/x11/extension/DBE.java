...
public class DBE extends Extension implements ErrorFactory {
  ...
  public DBE(org.gnu.escher.x11.Display display) throws NotFoundException { 
  ...
  public X11ServiceException build(org.gnu.escher.x11.Display display, int code, int seqNumber,
