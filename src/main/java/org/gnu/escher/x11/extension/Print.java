 ...
 * >protocol</a>;
 * <a href= "http://escher.sourceforge.net/etc/specification/print-server.ps.gz"
 * >server</a>).
 */
public class Print extends Extension implements ErrorFactory, EventFactory {
	...
	public enum PrintMask {
		XPNoEventMask(0), XPPrintMask(1), XPAttributeMask(2);
	...
	public enum Rule {
		ATTRIBUTE_REPLACE(1), ATTRIBUTE_MERGE(2);
	...
	public class Context extends org.gnu.escher.x11.Resource {
		...
		public class PageDimensions {
			...
			public int reproducibleX() {
				return reproducibleWidth;
			}

			public int reproducibleY() {
				return reproducibleHeight;
			}
		...
		public String attributes() {
			return attributes(Attributes.JOB_ATTRIBUTE_POOL) + attributes(Attributes.DOC_ATTRIBUTE_POOL)
					+ attributes(Attributes.PAGE_ATTRIBUTE_POOL) + attributes(Attributes.PRINTER_ATTRIBUTE_POOL)
	 ...
	 */
	public Print(Display display) throws org.gnu.escher.x11.extension.ExtensionNotFoundException {
	...
	public static final String[] ERROR_STRINGS = { "BAD_PRINT_CONTEXT: parameter not a PRINT context",
	...
	public class AttributeNotifyEvent extends org.gnu.escher.x11.event.Event {
		...
		/**
		 * @return valid: {@link Attributes}
		 */
		public Attributes detail() {
			return Attributes.values()[getDetail() + 1];
		}
	...
	public class ContextID extends org.gnu.escher.x11.event.Event {
		public static final int code = 0;
		...
		/**
		 * @return valid: {@link Notify},
		 */
		public Notify detail() {
			return Notify.values()[getDetail()];
		}
