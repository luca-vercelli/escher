...
public class GlyphRequest {
	...
	/**
	 * The X translation of the glyph. This value will be substracted from the
	 * current X location when rendering this glyph.
	 */
	private int x;

	/**
	 * The Y translation of the glyph. This value will be substracted from the
	 * current Y location when rendering this glyph.
	 */
	private int y;

	/**
	 * The X offset to the next glyph position. After rendering this glyph the X
	 * position will be advanced by that offset.
	 */
	private int offs_x;

	/**
	 * The Y offset to the next glyph position. After rendering this glyph the Y
	 * position will be advanced by that offset.
	 */
	private int offs_y;
