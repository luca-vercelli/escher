...
public class Shape extends Graphics {
  ...
  public Shape (String [] args) throws org.gnu.escher.x11.extension.ExtensionNotFoundException {
    ...
    org.gnu.escher.x11.extension.Shape shape = new org.gnu.escher.x11.extension.Shape (display);
    ...
    shape.combineMask (window, org.gnu.escher.x11.extension.Shape.Kind.BOUNDING, 0, 0,
      mask, org.gnu.escher.x11.extension.Shape.Operation.SUBTRACT);
  }


  public void dispatch_event () {
    super.dispatch_event ();
    if (event instanceof org.gnu.escher.x11.extension.Shape.NotifyEvent) {
      org.gnu.escher.x11.extension.Shape.NotifyEvent ne = 
        (org.gnu.escher.x11.extension.Shape.NotifyEvent) event;
