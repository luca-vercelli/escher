 ...
 *
 * @see <a href="../../../../etc/screenshot/gnu/x11/test/SendEvent.output"> text
 *      output</a>
 *
 * @see <a href="../../../../etc/screenshot/gnu/x11/test/SendEvent.help"> help
 *      output</a>
 */
public class SendEvent extends Graphics {
	public SendEvent(String[] args) {
		...
		about("0.1", "test sending synthetic events", "Stephen Tse <stephent@sfu.ca>",
