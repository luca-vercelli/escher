...
public class Quadric extends GLXApplication {
  ...
  private void init_object () {
    ...
    org.gnu.escher.x11.extension.glx.Quadric quadric = new org.gnu.escher.x11.extension.glx.Quadric (gl);

    // smooth shaded
    quadric.draw_style = org.gnu.escher.x11.extension.glx.Quadric.FILL;
    quadric.normals = org.gnu.escher.x11.extension.glx.Quadric.SMOOTH;
    ...
    // flat shaded
    quadric.draw_style = org.gnu.escher.x11.extension.glx.Quadric.FILL;
    quadric.normals = org.gnu.escher.x11.extension.glx.Quadric.FLAT;
    gl.new_list (display_list+1, GL.COMPILE);
    quadric.cylinder (0.5, 0.3, 1.0, 15, 5);
    gl.end_list ();

    // all polygon wireframe
    quadric.draw_style = org.gnu.escher.x11.extension.glx.Quadric.LINE;
    quadric.normals = org.gnu.escher.x11.extension.glx.Quadric.NONE;
    gl.new_list (display_list+2, GL.COMPILE);
    quadric.disk (0.25, 1.0, 20, 4);
    gl.end_list ();

    // boundary only
    quadric.draw_style = org.gnu.escher.x11.extension.glx.Quadric.SILHOUETTE;
    quadric.normals = org.gnu.escher.x11.extension.glx.Quadric.NONE;
